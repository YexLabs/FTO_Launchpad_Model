...
contract testTokenTimeLimit is ERC20 {
    ...
    function faucet() public {
        require(
            ...
            "Need to wait 24 hours for another faucet"
        );
        lastFaucetTime[msg.sender] = block.timestamp;
        _mint(msg.sender, _faucetAmount);
    }

    function isFaucteAvailable(address _address) public view returns (bool) {
        return block.timestamp - lastFaucetTime[_address] > 1 days;
    }
