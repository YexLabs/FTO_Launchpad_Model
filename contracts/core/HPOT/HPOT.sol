...
{
    string private constant NAME = "Honeypot Finance";
    string private constant SYMBOL = "HPOT";
    ...
    function initialize(
        ...
        require(_initialSupply != 0, "HPOT: ZERO_INITIAL_SUPPLY");
        require(_owner != address(0), "HPOT: ZERO_OWNER");
    ...
    function mint(address recipient, uint256 amount) external onlyOwner {
        ...
        require(block.timestamp >= nextMint, "HPOT: MINT_TOO_EARLY");
