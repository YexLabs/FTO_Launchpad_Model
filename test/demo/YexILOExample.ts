...
describe("YexILOExample", function () {
    ...
    describe("Deposit", function () {
        it("deposit faile when not enough allowance", async function () {
            ...
            await expect(yexILOExample.connect(owner).deposit(0, 1)).to.revertedWith("Not allowance token");
            await expect(yexILOExample.connect(otherAccount).deposit(1, 0)).to.revertedWith("Not allowance token");
    ...
    describe("Liquidity", function () {
        it("add liquidity fail when not enough allowance", async function () {
            ...
            await expect(yexILOExample.connect(otherAccount).addLiquidity(1, 0)).to.be.revertedWith("Not allowance token");
            await expect(yexILOExample.connect(otherAccount).addLiquidity(0, 1)).to.be.revertedWith("Not allowance token");
